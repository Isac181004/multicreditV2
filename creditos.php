...
<style>
    .service-hero {
        background:
            linear-gradient(90deg, rgba(6,20,38,.92), rgba(6,20,38,.62), rgba(6,20,38,.18)),
...
<style>
    ...
    <style>
        ...
        .simulator-shell {
            ...
            border-radius: 28px;
            box-shadow: 0 22px 60px rgba(5,11,20,.09);
            overflow: hidden;
        }
        .sim-card {
            background: #FFFFFF;
        ...
        .sim-result {
            background:
                ...
                linear-gradient(145deg, #0B1F3A 0%, #1F4E79 60%, #1F4E79 100%);
            color: #FFFFFF;
            position: relative;
            overflow: hidden;
        }
        ...
        .sim-table tbody tr:nth-child(even) { background: #FFFFFF; }
        ...
        .sim-toggle:hover { background: #FFFFFF; }
        .sim-whatsapp {
            background: #1F4E79;
...
.credit-page .credit-help-card{
    min-width:0;
    background:linear-gradient(135deg,#0B1F3A 0%,#1F4E79 100%) !important;
    color:#FFFFFF !important;
    border-radius:28px !important;
    padding:28px 32px !important;
    ...
    box-shadow:0 16px 35px rgba(22,58,99,.16);
}
.credit-page .credit-help-card *{
    color:#FFFFFF !important;
    opacity:1 !important;
...
.credit-page .credit-advisor-card{
    background:linear-gradient(135deg,#0B1F3A 0%,#061426 100%) !important;
    color:#FFFFFF !important;
    border-radius:28px !important;
    ...
    box-shadow:0 16px 35px rgba(22,58,99,.18);
}
.credit-page .credit-advisor-card *{
    opacity:1 !important;
    visibility:visible !important;
...
.credit-page .credit-hero::before{
    ...
    pointer-events:none;
    background:
        radial-gradient(circle at 18% 25%,rgba(31,78,121,.30),transparent 26%),
        radial-gradient(circle at 82% 18%,rgba(100,116,139,.18),transparent 23%);
...
.credit-page .credit-intro-main{
    ...
    box-shadow:0 22px 55px rgba(5,11,20,.10) !important;
    backdrop-filter:blur(13px);
}

.credit-page .credit-help-card{
    background:
        linear-gradient(135deg,rgba(6,20,38,.92),rgba(11,31,58,.88)),
        url("img/font2.jpg")
        center/cover no-repeat !important;
    background-blend-mode:multiply;
    box-shadow:0 24px 58px rgba(6,20,38,.22) !important;
}
...
#microempresa .credit-product-card-fix{
    ...
    box-shadow:0 15px 38px rgba(5,11,20,.09);
...
#microempresa .credit-product-card-fix:hover{
    ...
    box-shadow:0 28px 58px rgba(5,11,20,.16);
    border-color:rgba(31,78,121,.28) !important;
}
...
.credit-page .credit-advisor-card{
    background:
        linear-gradient(150deg,rgba(5,11,20,.91),rgba(22,58,99,.88)),
        url("img/font2.jpg")
        center/cover no-repeat !important;
    background-blend-mode:multiply;
    box-shadow:0 24px 55px rgba(6,20,38,.20) !important;
    transition:transform .35s ease,box-shadow .35s ease;
}

.credit-page .credit-advisor-card:hover{
    transform:translateY(-8px);
    box-shadow:0 32px 68px rgba(6,20,38,.27) !important;
}
...
#consumo article{
    ...
    box-shadow:0 16px 38px rgba(5,11,20,.09);
...
#consumo article:hover{
    transform:translateY(-9px);
    box-shadow:0 28px 58px rgba(5,11,20,.15);
}

 
.credit-page section.py-16.px-4.md\:px-10.bg-gray-50{
    background:
        linear-gradient(90deg,rgba(5,11,20,.94),rgba(6,20,38,.88)),
        url("img/font4.jpg")
        center/cover no-repeat !important;
}
...
#simulador{
    background:
        linear-gradient(180deg,rgba(243,244,246,.93),rgba(255,255,255,.97)),
...
#simulador > div > .grid > div:first-child{
    ...
    border:1px solid rgba(255,255,255,.78) !important;
    box-shadow:0 25px 60px rgba(5,11,20,.12) !important;
...
#simulador .sim-monto:hover{
    ...
    box-shadow:0 10px 22px rgba(5,11,20,.08);
}

#simulador .sim-result-panel{
    background:
        linear-gradient(145deg,rgba(5,11,20,.93),rgba(11,31,58,.86)),
        url("img/requisitos.webp")
        center/cover no-repeat !important;
    background-blend-mode:multiply;
    box-shadow:0 28px 65px rgba(6,20,38,.26) !important;
}

#simTablaWrap{
    background:rgba(255,255,255,.96) !important;
    box-shadow:0 25px 60px rgba(5,11,20,.11) !important;
}
...
.credit-page section:nth-of-type(2){
    background:
        linear-gradient(90deg,rgba(255,255,255,.79),rgba(255,255,255,.70)),
        url("img/font3.jpg")
        center/cover no-repeat !important;
}
.credit-page .credit-intro-main{
...
.credit-page .credit-help-card{
    background:
        linear-gradient(135deg,rgba(6,20,38,.72),rgba(11,31,58,.66)),
...
#microempresa article:nth-child(1) h3{color:#374151 !important;}
#microempresa article:nth-child(2) h3{color:#0B1F3A !important;}
#microempresa article:nth-child(3) h3{color:#0B1F3A !important;}
#microempresa article:nth-child(4) h3{color:#1F4E79 !important;}
#microempresa article:nth-child(5) h3{color:#1F4E79 !important;}

 
.credit-page .credit-advisor-card{
    background:
        linear-gradient(150deg,rgba(5,11,20,.68),rgba(22,58,99,.61)),
...
#consumo article:nth-child(1) h3{color:#1F4E79 !important;}
#consumo article:nth-child(2) h3{color:#1F4E79 !important;}
#consumo article:nth-child(3) h3{color:#1F4E79 !important;}
#consumo article p{
    color:#0B1F3A !important;
}
#consumo article a{
...
.credit-page section.py-16.px-4.md\:px-10.bg-gray-50{
    background:
        linear-gradient(90deg,rgba(5,11,20,.72),rgba(6,20,38,.61)),
        url("img/font4.jpg")
        center/cover no-repeat !important;
}
...
.credit-page section.px-4.md\:px-10.pb-10.bg-gray-50{
    background:linear-gradient(180deg,#F3F4F6,#FFFFFF) !important;
}
...
#simulador{
    background:
        linear-gradient(180deg,rgba(243,244,246,.72),rgba(255,255,255,.82)),
        url("img/font1.jpg")
        center/cover no-repeat !important;
}
...
#simulador .sim-result-panel{
    background:
        linear-gradient(145deg,rgba(5,11,20,.70),rgba(11,31,58,.61)),
        url("img/requisitos.webp")
        center/cover no-repeat !important;
}
...
.sim-result-panel{background:#0B1F3A !important;background:linear-gradient(145deg,#061426 0%,#0B1F3A 55%,#1F4E79 100%) !important;color:#FFFFFF !important;min-height:520px;box-shadow:0 18px 45px rgba(22,58,99,.20);}
...
.sim-result-panel .sim-result-box{background:rgba(0,0,0,.13);border:1px solid rgba(255,255,255,.15);border-radius:18px;color:#FFFFFF !important;}
...
.sim-result-panel .sim-whatsapp-btn{display:inline-flex;background:#1F4E79 !important;color:#FFFFFF !important;text-decoration:none;}
...
<style>
.sede-option:focus{outline:none;box-shadow:0 0 0 4px rgba(31,78,121,.10)}
  ...
  <div class="bg-white w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden">
    ...
    <div class="p-6 md:p-8">
      ...
      <div class="mt-6 flex flex-col sm:flex-row gap-3">
        ...
        <button type="button" id="enviarSedeWhatsApp" disabled class="sm:flex-1 rounded-full bg-[#1F4E79] disabled:bg-gray-300 disabled:cursor-not-allowed text-white py-3.5 font-extrabold flex items-center justify-center gap-2 shadow-lg">
