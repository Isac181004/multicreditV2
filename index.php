...
<head>
    ...
    <style>
        ...
        .hero-gradient {
            background:
                linear-gradient(90deg, rgba(6,20,38,.92) 0%, rgba(16,42,67,.62) 48%, rgba(11,31,58,.25) 100%);
        }
        ...
        .stat-card:hover { transform: translateY(-6px); box-shadow: 0 22px 50px rgba(11,31,58,.18); }
        ...
        .service-card::before {
            ...
            background: radial-gradient(280px circle at var(--mx,50%) var(--my,50%), rgba(11,31,58,.10), transparent 60%);
            opacity: 0;
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 20px 40px rgba(100,116,139,.30);
            background: #64748B;
        }
        ...
        .btn-ghost:hover { background: #FFFFFF; color: #0B1F3A; transform: translateY(-4px); }
        



:root {
    --glass-green: rgba(11,31,58,.055);
    --glass-green-medium: rgba(11,31,58,.085);
    --glass-white: rgba(255,255,255,.58);
    --glass-border: rgba(11,31,58,.13);
    --glass-shadow: 0 20px 55px rgba(6,20,38,.10);
}
...
.service-card {
    ...
    border:
        1px solid rgba(11,31,58,.10) !important;

    box-shadow:
        0 18px 45px rgba(6,20,38,.07),
...
.news-card {
    ...
    box-shadow:
        0 20px 50px rgba(6,20,38,.08) !important;
...
@media (max-width: 767px) {
    ...
    .testimonial-glass {
        ...
        :root{
            ...
            --glass-shadow: 0 24px 70px rgba(16,42,67,.10);
            --glass-dark: rgba(6,20,38,.76);
        }

        body{
            background:
                radial-gradient(circle at 10% 8%, rgba(100,116,139,.055), transparent 28%),
                radial-gradient(circle at 90% 14%, rgba(11,31,58,.07), transparent 30%),
                linear-gradient(180deg,#FFFFFF 0%,#FFFFFF 32%,#FFFFFF 100%);
        }
        ...
        section.relative.z-20.-mt-8 > div{
            ...
            box-shadow: 0 24px 60px rgba(6,20,38,.13) !important;
        }
        ...
        #bienvenidos .relative.floating{
            ...
            box-shadow: 0 35px 80px rgba(6,20,38,.14);
        }
        ...
        section.bg-brand-green{
            background:
                radial-gradient(circle at 88% 15%, rgba(100,116,139,.18), transparent 26%),
                radial-gradient(circle at 8% 90%, rgba(255,255,255,.10), transparent 25%),
                linear-gradient(135deg,#102A43,#0B1F3A) !important;
        }
        ...
        section.py-24.bg-gray-50 .service-card{
            ...
            box-shadow: 0 18px 50px rgba(6,20,38,.06);
            border-radius: 1.5rem;
        }
        ...
        section#agencias .grid.sm\:grid-cols-2 > div{
            ...
            border: 1px solid rgba(255,255,255,.82);
            box-shadow: 0 14px 40px rgba(6,20,38,.05);
        }
        ...
        section.py-24.bg-white .news-card{
            ...
            box-shadow: 0 20px 55px rgba(6,20,38,.08);
        }
        ...
        .btn-primary{
            border-radius: 1rem;
            box-shadow: 0 14px 32px rgba(100,116,139,.20);
        }

        .btn-primary:hover{
            box-shadow: 0 22px 45px rgba(100,116,139,.30);
        }
