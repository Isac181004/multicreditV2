...
<head>
    ...
    <title>CrediEmpeño | CEPRODEMIC MULTICREDIT</title>
    <meta name="description" content="Obtén liquidez con una garantía prendaria. Conoce CrediEmpeño, una alternativa de financiamiento de Multicredit.">
    <script>
...
<style id="mc-crediempeno-legibilidad-final">
...
:root{
    --mc-green:#071525;
    --mc-green-dark:#071525;
    --mc-green-deep:#071525;
    --mc-orange:#0B1F3A;
    --mc-gold:#0B1F3A;
    --mc-text:#071525;
    --mc-text-soft:#374151;
...
main > section:first-of-type h1{
    text-shadow:0 8px 28px rgba(10,10,10,.38);
}

main > section:first-of-type p{
    color:#F3F4F6 !important;
    text-shadow:0 3px 14px rgba(10,10,10,.28);
}
...
.hero-corner-photo{
    z-index:1;
    opacity:.96;
    animation:heroCircleFloat 7s ease-in-out infinite alternate;
    box-shadow:0 24px 60px rgba(10,10,10,.30);
}
.hero-corner-photo::after{
    content:"";
    position:absolute;
    inset:0;
    border-radius:9999px;
    background:linear-gradient(135deg,rgba(7,21,37,.10),rgba(22,58,95,.10));
    pointer-events:none;
}
...
@keyframes heroCircleFloat{
    ...
    to{transform:translate3d(-8px,8px,0) scale(1.025)}
}

 
main > section:first-of-type .w-20.h-20{
    background:rgba(243,244,246,.94) !important;
    color:#0B1F3A !important;
    border:1px solid rgba(255,255,255,.65);
    box-shadow:0 18px 40px rgba(10,10,10,.22);
}

 
main > section:nth-of-type(2){
    background:
        linear-gradient(rgba(243,244,246,.84),rgba(243,244,246,.84)),
        url("img/font4.webp")
        center/cover no-repeat !important;
}
...
main > section:nth-of-type(3){
    background:
        linear-gradient(rgba(243,244,246,.72),rgba(255,255,255,.78)),
        url("img/font4.webp")
        center/cover no-repeat !important;
}
...
main > section:nth-of-type(4){
    background:
        linear-gradient(rgba(255,255,255,.86),rgba(243,244,246,.88)),
        url("img/font4.webp")
        center/cover no-repeat !important;
}
...
main > section:nth-of-type(5){
    background:
        linear-gradient(rgba(243,244,246,.74),rgba(255,255,255,.80)),
        url("img/font4.webp")
        center/cover no-repeat !important;
}
...
main > section:nth-of-type(7){
    background:
        linear-gradient(rgba(243,244,246,.78),rgba(255,255,255,.84)),
        url("img/font4.webp")
        center/cover no-repeat !important;
}
...
main > section:nth-of-type(n+2):not(:last-of-type) .bg-white.rounded-2xl,
main > section:nth-of-type(n+2):not(:last-of-type) .rounded-2xl.bg-gray-50,
...
main > section:nth-of-type(n+2):not(:last-of-type) details.group{
    ...
    box-shadow:0 18px 45px rgba(7,21,37,.12) !important;
...
main > section:nth-of-type(3) .grid > div:first-child{
    border-top:4px solid #071525 !important;
}
main > section:nth-of-type(3) .grid > div:last-child{
    border-top:4px solid #163A5F !important;
}
...
main > section:last-of-type .rounded-2xl{
    background:
        linear-gradient(115deg,rgba(7,21,37,.88),rgba(7,21,37,.82)),
        url("img/bank.webp")
        center/cover no-repeat !important;
}
...
main > section:last-of-type h2{
    text-shadow:0 4px 16px rgba(10,10,10,.26);
}
...
main .rounded-2xl.bg-gray-50:hover,
main .rounded-2xl.border:hover,
main details.group:hover{
    transform:translateY(-4px);
    box-shadow:0 25px 55px rgba(7,21,37,.16) !important;
}
...
<main class="pt-[88px] md:pt-[96px]">
    ...
    <section class="relative overflow-hidden text-white bg-gradient-to-br from-[#071525] via-[#071525] to-[#071525]">
        <div class="absolute inset-0 opacity-10 bg-[radial-gradient(#FFFFFF_1px,transparent_1px)] [background-size:18px_18px]"></div>
        <div class="absolute -right-20 -top-20 w-72 h-72 md:w-96 md:h-96 rounded-full overflow-hidden border-[10px] border-white/15 shadow-2xl hero-corner-photo">
            <img src="https://i.blogs.es/94e5d4/ipad/1200_900.jpeg"
                 alt="Joyas y garantía prendaria"
                 class="w-full h-full object-cover">
        </div>
        <div class="max-w-7xl mx-auto px-4 md:px-10 py-16 md:py-24 relative z-10">
            <div class="max-w-4xl mc-reveal">
                ...
                <div class="flex flex-col md:flex-row gap-7 md:items-center">
                    <div class="w-20 h-20 rounded-2xl bg-amber-50 text-amber-700 flex items-center justify-center text-3xl shadow-xl shrink-0 tilt-3d">
                        <span class="tilt-layer"><i class="fas fa-gem"></i></span>
                    </div>
                    <div>
                        ...
                        <h1 class="text-4xl md:text-6xl font-black mt-4 tracking-tight">CrediEmpeño</h1>
                        <p class="text-lg md:text-xl text-green-50 mt-4 max-w-3xl leading-relaxed">Obtén liquidez con una garantía prendaria.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-14 md:py-16 px-4 md:px-10 bg-white">
        <div class="max-w-7xl mx-auto grid lg:grid-cols-3 gap-7">
            ...
            <div class="rounded-2xl bg-gray-50 border border-gray-200 p-6 md:p-7 shadow-sm mc-reveal">
                ...
                <a href="https://wa.me/51968782473?text=Hola%20Multicredit%2C%20deseo%20informaci%C3%B3n%20sobre%20CrediEmpe%C3%B1o." target="_blank" rel="noopener noreferrer"
                   class="btn-shine mt-6 w-full inline-flex items-center justify-center gap-2 bg-brand-orange text-white px-5 py-3.5 rounded-lg font-extrabold transition">
                    <i class="fab fa-whatsapp text-lg"></i> Solicitar información
                </a>
                <a href="creditos.php#simulador"
                   class="mt-3 w-full inline-flex items-center justify-center gap-2 border border-brand-green text-brand-green hover:bg-green-50 px-5 py-3.5 rounded-lg font-extrabold transition">
        ...
        <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 p-7 md:p-9 shadow-sm tilt-3d mc-reveal">
                ...
                <ul class="mt-7 space-y-4 text-gray-600 leading-relaxed">
                    ...
                    <li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Compra de mercadería</span></li>
                    <li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Atender una necesidad puntual</span></li>
                    <li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Cubrir necesidades de liquidez</span></li>
                </ul>
                </div>
            </div>
            <div class="bg-white rounded-2xl border border-gray-100 p-7 md:p-9 shadow-sm tilt-3d mc-reveal">
    ...
    <section class="py-14 md:py-18 px-4 md:px-10 bg-white">
        <div class="max-w-7xl mx-auto">
            <div class="text-center max-w-2xl mx-auto mc-reveal">
    ...
    <section class="py-14 md:py-18 px-4 md:px-10 bg-gray-50">
        <div class="max-w-5xl mx-auto">
            ...
            <div class="mt-9 bg-white rounded-2xl border border-gray-200 p-7 md:p-9 mc-reveal">
    ...
    <section class="py-14 md:py-18 px-4 md:px-10 bg-white">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-4 gap-5 mt-10">
                <div class="text-center tilt-3d mc-reveal"><div class="tilt-layer"><div class="mx-auto w-12 h-12 rounded-full bg-green-50 text-brand-green flex items-center justify-center font-black">01</div><h3 class="font-black mt-4">Consulta</h3><p class="text-sm text-gray-500 mt-1">Cuéntanos qué necesitas financiar.</p></div></div>
                <div class="text-center tilt-3d mc-reveal"><div class="tilt-layer"><div class="mx-auto w-12 h-12 rounded-full bg-green-50 text-brand-green flex items-center justify-center font-black">02</div><h3 class="font-black mt-4">Requisitos</h3><p class="text-sm text-gray-500 mt-1">Conoce la documentación que corresponde.</p></div></div>
                <div class="text-center tilt-3d mc-reveal"><div class="tilt-layer"><div class="mx-auto w-12 h-12 rounded-full bg-green-50 text-brand-green flex items-center justify-center font-black">03</div><h3 class="font-black mt-4">Evaluación</h3><p class="text-sm text-gray-500 mt-1">Se analiza tu solicitud y capacidad de pago.</p></div></div>
                <div class="text-center tilt-3d mc-reveal"><div class="tilt-layer"><div class="mx-auto w-12 h-12 rounded-full bg-green-50 text-brand-green flex items-center justify-center font-black">04</div><h3 class="font-black mt-4">Respuesta</h3><p class="text-sm text-gray-500 mt-1">Recibes información sobre el resultado y condiciones.</p></div></div>
            </div>
        </div>
    </section>
    ...
    <section class="py-14 md:py-18 px-4 md:px-10 bg-gray-50">
        <div class="max-w-4xl mx-auto">
            ...
            <summary class="cursor-pointer list-none flex items-center justify-between gap-4 font-extrabold text-gray-800">
                <span>¿Qué puedo dejar en garantía?</span><i class="fas fa-plus text-brand-green group-open:rotate-45 transition"></i>
            </summary>
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">La garantía debe cumplir con las condiciones de aceptación y valorización establecidas por Multicredit.</p>
        </details><details class="group rounded-2xl border border-gray-200 bg-white p-5">
            <summary class="cursor-pointer list-none flex items-center justify-between gap-4 font-extrabold text-gray-800">
                <span>¿Cómo se determina el monto?</span><i class="fas fa-plus text-brand-green group-open:rotate-45 transition"></i>
            </summary>
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">El monto depende de la evaluación de la garantía, la capacidad de pago y las condiciones vigentes.</p>
        </details><details class="group rounded-2xl border border-gray-200 bg-white p-5">
            <summary class="cursor-pointer list-none flex items-center justify-between gap-4 font-extrabold text-gray-800">
                <span>¿La garantía asegura la aprobación?</span><i class="fas fa-plus text-brand-green group-open:rotate-45 transition"></i>
            </summary>
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">No. Toda solicitud está sujeta a evaluación y al cumplimiento de los requisitos correspondientes.</p>
        </details></div>
        </div>
    </section>
    ...
    <section class="px-4 md:px-10 py-12 bg-gray-50">
        <div class="max-w-7xl mx-auto rounded-2xl bg-gradient-to-r from-[#071525] to-[#071525] text-white p-8 md:p-12 flex flex-col lg:flex-row items-center justify-between gap-7 mc-reveal">
            <div>
            ...
            <a href="https://wa.me/51968782473?text=Hola%20Multicredit%2C%20deseo%20informaci%C3%B3n%20sobre%20CrediEmpe%C3%B1o." target="_blank" rel="noopener noreferrer"
               class="btn-shine shrink-0 inline-flex items-center gap-2 bg-brand-orange text-white px-7 py-4 rounded-lg font-extrabold transition">
...
<script id="mc-crediempeno-visibility-failsafe">
