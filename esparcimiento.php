    ...
    <section class="py-14 md:py-16 px-4 md:px-10 bg-white">
        <div class="max-w-7xl mx-auto grid lg:grid-cols-3 gap-7">
            <div class="lg:col-span-2">
                ...
                <h2 class="text-3xl md:text-4xl font-black mt-2">Disfruta momentos especiales con una adecuada planificación</h2>
                <p class="text-gray-600 text-lg leading-relaxed mt-5 max-w-4xl">Una alternativa de financiamiento destinada a cubrir necesidades de recreación, descanso y actividades personales o familiares.<br>
                Con el Crédito Esparcimiento de Multicredit puedes organizar aquellas experiencias importantes para ti y tu familia, distribuyendo el gasto de acuerdo con las condiciones establecidas y tu capacidad de pago.</p>
            ...
            <div class="rounded-3xl bg-gray-50 border border-gray-200 p-6 md:p-7 shadow-sm">
                ...
                <a href="https://wa.me/51968782473?text=Hola%20Multicredit%2C%20deseo%20informaci%C3%B3n%20sobre%20Cr%C3%A9dito%20Esparcimiento." target="_blank" rel="noopener noreferrer"
...
<li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Otras necesidades de esparcimiento contempladas por el producto</span></li>
            ...
            <div class="bg-white rounded-3xl border border-gray-100 p-7 md:p-9 shadow-sm">
                ...
                <ul class="mt-7 space-y-4 text-gray-600 leading-relaxed">
                    <li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Financiamiento para diferentes actividades personales y familiares.</span></li>
