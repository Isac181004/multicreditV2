...
<head>
    ...
    <title>Crédito Educación | CEPRODEMIC MULTICREDIT</title>
    <meta name="description" content="Invertir en educación es invertir en oportunidades. Conoce Crédito Educación, una alternativa de financiamiento de Multicredit.">
    <script>
...
<body class="bg-gray-50 text-gray-800 overflow-x-hidden mc-ultra-page" data-product="educacion">
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-10 py-16 md:py-24 relative z-10">
            <div class="max-w-4xl">
                ...
                <div class="flex flex-col md:flex-row gap-7 md:items-center">
                    <div class="w-20 h-20 rounded-3xl bg-blue-50 text-blue-700 flex items-center justify-center text-3xl shadow-xl shrink-0">
                    ...
                    <div>
                        ...
                        <h1 class="text-4xl md:text-6xl font-black mt-4 tracking-tight">Crédito Educación</h1>
                        <p class="text-lg md:text-xl text-green-50 mt-4 max-w-3xl leading-relaxed">Invertir en educación es invertir en oportunidades.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-14 md:py-16 px-4 md:px-10 bg-white">
        <div class="max-w-7xl mx-auto grid lg:grid-cols-3 gap-7">
            <div class="lg:col-span-2">
                ...
                <h2 class="text-3xl md:text-4xl font-black mt-2">Invierte hoy en un futuro con más oportunidades</h2>
                <p class="text-gray-600 text-lg leading-relaxed mt-5 max-w-4xl">Una alternativa de financiamiento diseñada para atender gastos relacionados con estudios, formación profesional y capacitación, ya sea para ti o para algún integrante de tu familia.<br>
                Con el Crédito Educación de Multicredit puedes cubrir oportunamente diferentes necesidades académicas y continuar avanzando hacia tus metas sin detener tu formación por falta de recursos.</p>
            ...
            <div class="rounded-3xl bg-gray-50 border border-gray-200 p-6 md:p-7 shadow-sm">
                ...
                <a href="https://wa.me/51968782473?text=Hola%20Multicredit%2C%20deseo%20informaci%C3%B3n%20sobre%20Cr%C3%A9dito%20Educaci%C3%B3n." target="_blank" rel="noopener noreferrer"
        ...
        <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8">
            <div class="bg-white rounded-3xl border border-gray-100 p-7 md:p-9 shadow-sm">
                ...
                <ul class="mt-7 space-y-4 text-gray-600 leading-relaxed">
                    <li class="flex gap-3"><i class="fas fa-check-circle text-brand-green mt-1"></i><span>Estudiantes y familias</span></li>
<li class="flex gap-3"><i class="fas fa-check-circle text-brand-green mt-1"></i><span>Personas que necesitan cubrir gastos educativos</span></li>
<li class="flex gap-3"><i class="fas fa-check-circle text-brand-green mt-1"></i><span>Familias que buscan financiar una etapa de formación</span></li>
                </ul>
            </div>
            <div class="bg-white rounded-3xl border border-gray-100 p-7 md:p-9 shadow-sm">
                ...
                <ul class="mt-7 space-y-4 text-gray-600 leading-relaxed">
                    <li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Matrículas y pensiones</span></li>
<li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Materiales y útiles</span></li>
<li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Uniformes o implementos</span></li>
<li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Otros gastos vinculados a la educación</span></li>
                </ul>
            </div>
            <div class="bg-white rounded-3xl border border-gray-100 p-7 md:p-9 shadow-sm">
                <h2 class="text-2xl md:text-3xl font-black mt-2">Principales beneficios</h2>
                <ul class="mt-7 space-y-4 text-gray-600 leading-relaxed">
                    <li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Financiamiento para diferentes niveles educativos.</span></li>
...
<li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Posibilidad de financiar tus estudios o los de un familiar.</span></li>
                </ul>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="mt-9 bg-white rounded-3xl border border-gray-200 p-7 md:p-9">
                <div class="grid md:grid-cols-2 gap-5 text-gray-600">
                    <div class="flex gap-3"><i class="fas fa-id-card text-brand-orange mt-1"></i><span>Presentar documentos personales vigentes.</span></div>
                    ...
                    <div class="flex gap-3"><i class="fas fa-file-lines text-brand-orange mt-1"></i><span>Ficha de matrícula, constancia de pensiones o derechos de enseñanza.</span></div>
                    <div class="flex gap-3"><i class="fas fa-folder-open text-brand-orange mt-1"></i><span>Recibos u otros documentos que evidencien el uso educativo del dinero.</span></div>
                </div>
    ...
    <section class="py-14 md:py-18 px-4 md:px-10 bg-gray-50">
        <div class="max-w-4xl mx-auto">
            ...
            <summary class="cursor-pointer list-none flex items-center justify-between gap-4 font-extrabold text-gray-800">
                <span>¿Para qué gastos educativos puedo solicitarlo?</span><i class="fas fa-plus text-brand-green group-open:rotate-45 transition"></i>
            </summary>
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">Puede destinarse a necesidades educativas contempladas por el producto, previa evaluación.</p>
            ...
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">La solicitud puede ser evaluada según el perfil del solicitante, capacidad de pago y condiciones vigentes.</p>
        </details><details class="group rounded-2xl border border-gray-200 bg-white p-5">
            <summary class="cursor-pointer list-none flex items-center justify-between gap-4 font-extrabold text-gray-800">
                <span>¿Cuánto puedo solicitar?</span><i class="fas fa-plus text-brand-green group-open:rotate-45 transition"></i>
            </summary>
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">El monto depende de la evaluación y de las condiciones vigentes del producto.</p>
        </details></div>
        </div>
    </section>
