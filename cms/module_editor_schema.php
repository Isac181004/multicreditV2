        ...
        'groups'=>[
            mc_me_group('Portada del crédito','Imagen, categoría, nombre y frase principal.',[
                mc_me_field('hero_image','Imagen de portada','image','','css',['rules'=>[
                    ['selector'=>'main > section:first-of-type','property'=>'background','template'=>"linear-gradient(100deg,rgba(7,21,37,.84),rgba(7,21,37,.56)),url('%s') center/cover no-repeat"]
                ]]),
            ...
            mc_me_group('Diseño de esta ficha','Estos colores solo afectan al módulo seleccionado.',[
                ...
                mc_me_color('color_green_dark','Verde oscuro','#071525',[
                    ['selector'=>':root','property'=>'--mc-green-dark','template'=>'%s']
                ]),
                mc_me_color('color_orange','Naranja / acento','#0B1F3A',[
    ...
    return [
        ...
        'groups'=>[
            ...
            mc_me_group('Diseño','',[
                ...
                mc_me_color('color_orange','Naranja','#163A5F',[
                    ['selector'=>'main .text-brand-orange','property'=>'color','template'=>'%s'],
                    ['selector'=>'main .bg-brand-orange','property'=>'background-color','template'=>'%s']
                ]),
            ]),
...
function mc_me_services_schema() {
    ...
    return [
        ...
        'groups'=>[
            ...
            mc_me_group('Colores','',[
                mc_me_color('color_green','Verde principal','#071525',[
                ...
                mc_me_color('color_orange','Naranja de acento','#163A5F',[
    ...
    return [
        ...
        'groups'=>[
            ...
            mc_me_group('Enfoque y colores','',[
                ...
                mc_me_color('color_green','Verde institucional','#071525',[
                    ['selector'=>'.stat-number,.history-year strong','property'=>'color','template'=>'%s'],
                    ['selector'=>'.purpose-card.mission','property'=>'background','template'=>'linear-gradient(145deg,#071525,%s)']
                ]),
                mc_me_color('color_orange','Naranja institucional','#163A5F',[
                    ['selector'=>'.hero-title span,.hero-eyebrow i','property'=>'color','template'=>'%s'],
                    ['selector'=>'.purpose-card.vision','property'=>'background','template'=>'linear-gradient(145deg,%s,#0B1F3A)']
                ]),
            ]),
        ]
    ];
        ...
        'groups'=>[
            mc_me_group('Hero del catálogo','',[
                mc_me_field('hero_image','Imagen de fondo','image','','css',['rules'=>[
                    ['selector'=>'.credit-page .credit-hero','property'=>'background','template'=>"linear-gradient(90deg,rgba(7,21,37,.92),rgba(7,21,37,.55)),url('%s') center/cover no-repeat"]
                ]]),
            ...
            mc_me_group('Simulador y diseño','La lógica financiera queda protegida.',[
                ...
                mc_me_field('sim_background','Fondo del simulador','image','','css',['rules'=>[
                    ['selector'=>'#simulador','property'=>'background','template'=>"linear-gradient(180deg,rgba(243,244,246,.80),rgba(243,244,246,.88)),url('%s') center/cover no-repeat"]
                ]]),
                mc_me_color('color_green','Verde principal','#0B1F3A',[
...
function mc_me_microcredit_schema() {
    ...
    return [
        ...
        'groups'=>[
            ...
            mc_me_group('Diseño','',[
                mc_me_color('color_green','Verde','#071525',[
                    ['selector'=>'main .text-brand-green','property'=>'color','template'=>'%s'],
...
function mc_me_simple_schema($label) {
    return [
        ...
        'groups'=>[
            ...
            mc_me_group('Diseño','',[
                mc_me_color('color_green','Verde principal','#071525',[[ 'selector'=>':root','property'=>'--mc-green','template'=>'%s' ]]),
                mc_me_color('color_orange','Naranja','#163A5F',[[ 'selector'=>':root','property'=>'--mc-orange','template'=>'%s' ]]),
            ]),
        ]
    ];
}
