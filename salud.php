...
<head>
    ...
    <title>Crédito Salud | CEPRODEMIC MULTICREDIT</title>
    <meta name="description" content="Apoyo financiero cuando más lo necesitas. Conoce Crédito Salud, una alternativa de financiamiento de Multicredit.">
    <script>
...
<body class="bg-gray-50 text-gray-800 overflow-x-hidden mc-ultra-page" data-product="salud">
        ...
        <div class="max-w-7xl mx-auto px-4 md:px-10 py-16 md:py-24 relative z-10">
            <div class="max-w-4xl">
                ...
                <div class="flex flex-col md:flex-row gap-7 md:items-center">
                    <div class="w-20 h-20 rounded-3xl bg-red-50 text-red-600 flex items-center justify-center text-3xl shadow-xl shrink-0">
                    ...
                    <div>
                        ...
                        <h1 class="text-4xl md:text-6xl font-black mt-4 tracking-tight">Crédito Salud</h1>
                        <p class="text-lg md:text-xl text-green-50 mt-4 max-w-3xl leading-relaxed">Apoyo financiero cuando más lo necesitas.</p>
                    </div>
                </div>
            </div>
        </div>
...
<li class="flex gap-3"><i class="fas fa-check-circle text-brand-green mt-1"></i><span>Personas que enfrentan gastos relacionados con salud</span></li>
<li class="flex gap-3"><i class="fas fa-check-circle text-brand-green mt-1"></i><span>Clientes que requieren apoyo para atender una necesidad médica</span></li>
                </ul>
            </div>
            <div class="bg-white rounded-3xl border border-gray-100 p-7 md:p-9 shadow-sm">
                ...
                <ul class="mt-7 space-y-4 text-gray-600 leading-relaxed">
                    <li class="flex gap-3"><i class="fas fa-circle-check text-brand-green mt-1"></i><span>Consultas y atención médica</span></li>
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="mt-9 bg-white rounded-3xl border border-gray-200 p-7 md:p-9">
                <div class="grid md:grid-cols-2 gap-5 text-gray-600">
                    ...
                    <div class="flex gap-3"><i class="fas fa-file-lines text-brand-orange mt-1"></i><span>Presentar recetas médicas o proformas de servicios médicos.</span></div>
                    <div class="flex gap-3"><i class="fas fa-folder-open text-brand-orange mt-1"></i><span>Acreditar el uso del dinero con boletas, facturas o recibos del proveedor del servicio.</span></div>
                </div>
    ...
    <section class="py-14 md:py-18 px-4 md:px-10 bg-gray-50">
        <div class="max-w-4xl mx-auto">
            ...
            <summary class="cursor-pointer list-none flex items-center justify-between gap-4 font-extrabold text-gray-800">
                <span>¿Qué gastos de salud puedo financiar?</span><i class="fas fa-plus text-brand-green group-open:rotate-45 transition"></i>
            </summary>
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">La cobertura depende de las condiciones vigentes del producto y de la evaluación correspondiente.</p>
        </details><details class="group rounded-2xl border border-gray-200 bg-white p-5">
            <summary class="cursor-pointer list-none flex items-center justify-between gap-4 font-extrabold text-gray-800">
                <span>¿Puedo solicitarlo para un familiar?</span><i class="fas fa-plus text-brand-green group-open:rotate-45 transition"></i>
            </summary>
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">La posibilidad depende de las condiciones del producto y del perfil del solicitante.</p>
        </details><details class="group rounded-2xl border border-gray-200 bg-white p-5">
            <summary class="cursor-pointer list-none flex items-center justify-between gap-4 font-extrabold text-gray-800">
                <span>¿Cómo se determina el monto?</span><i class="fas fa-plus text-brand-green group-open:rotate-45 transition"></i>
            </summary>
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">Se considera la necesidad, capacidad de pago y criterios de evaluación establecidos.</p>
        </details></div>
        </div>
    </section>
