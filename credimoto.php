...
<head>
    ...
    <title>CrediMoto | CEPRODEMIC MULTICREDIT</title>
    <meta name="description" content="Una motocicleta también puede ser una herramienta para crecer. Conoce CrediMoto, una alternativa de financiamiento de Multicredit.">
    <script>
            ...
            <div class="max-w-4xl">
                ...
                <div class="flex flex-col md:flex-row gap-7 md:items-center">
                    ...
                    <div>
                        ...
                        <h1 class="text-4xl md:text-6xl font-black mt-4 tracking-tight">CrediMoto</h1>
                        <p class="text-lg md:text-xl text-green-50 mt-4 max-w-3xl leading-relaxed">Una motocicleta también puede ser una herramienta para crecer.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8">
            <div class="bg-white rounded-3xl border border-gray-100 p-7 md:p-9 shadow-sm">
                ...
                <ul class="mt-7 space-y-4 text-gray-600 leading-relaxed">
                    <li class="flex gap-3"><i class="fas fa-check-circle text-brand-green mt-1"></i><span>Emprendedores</span></li>
<li class="flex gap-3"><i class="fas fa-check-circle text-brand-green mt-1"></i><span>Trabajadores independientes</span></li>
<li class="flex gap-3"><i class="fas fa-check-circle text-brand-green mt-1"></i><span>Personas que necesitan movilidad para generar ingresos</span></li>
<li class="flex gap-3"><i class="fas fa-check-circle text-brand-green mt-1"></i><span>Actividades que requieren una motocicleta como herramienta de trabajo</span></li>
                </ul>
            </div>
            <div class="bg-white rounded-3xl border border-gray-100 p-7 md:p-9 shadow-sm">
    ...
    <section class="py-14 md:py-18 px-4 md:px-10 bg-gray-50">
        <div class="max-w-4xl mx-auto">
            ...
            <summary class="cursor-pointer list-none flex items-center justify-between gap-4 font-extrabold text-gray-800">
                <span>¿Puedo solicitarlo para una motocicleta nueva o usada?</span><i class="fas fa-plus text-brand-green group-open:rotate-45 transition"></i>
            </summary>
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">La posibilidad depende de las condiciones vigentes y de los criterios de evaluación aplicables al producto.</p>
        </details><details class="group rounded-2xl border border-gray-200 bg-white p-5">
            <summary class="cursor-pointer list-none flex items-center justify-between gap-4 font-extrabold text-gray-800">
                <span>¿Cuánto puedo financiar?</span><i class="fas fa-plus text-brand-green group-open:rotate-45 transition"></i>
            </summary>
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">El monto se determina según el valor de la operación, capacidad de pago y evaluación crediticia.</p>
        </details><details class="group rounded-2xl border border-gray-200 bg-white p-5">
            <summary class="cursor-pointer list-none flex items-center justify-between gap-4 font-extrabold text-gray-800">
                <span>¿La aprobación es automática?</span><i class="fas fa-plus text-brand-green group-open:rotate-45 transition"></i>
            </summary>
            <p class="text-gray-600 text-sm leading-relaxed mt-4 pr-8">No. Toda solicitud requiere evaluación y cumplimiento de los requisitos correspondientes.</p>
        </details></div>
        </div>
    </section>
