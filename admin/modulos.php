...
function mc_render_specific_field($field, $structured) {
    ...
    <div class="field mc-specific-field<?=$full?>">
        ...
        <?php elseif ($type === 'color'): 
            $default = (string)($field['default'] ?? '#071525');
...
?>
<style>
.mc-module-layout{display:grid;grid-template-columns:300px minmax(0,1fr);gap:18px;align-items:start}.mc-module-list{display:grid;gap:7px;margin-top:14px;max-height:72vh;overflow:auto;padding-right:3px}.mc-module-link{display:flex!important;align-items:center;gap:9px;justify-content:flex-start!important;text-align:left!important}.mc-module-link small{opacity:.62;margin-left:auto;font-size:10px}.mc-module-kind{display:inline-flex;align-items:center;background:#F3F4F6;color:#071525;border:1px solid #F3F4F6;border-radius:999px;padding:5px 9px;font-size:11px;font-weight:800;margin-top:7px}.mc-editor-head{display:flex;justify-content:space-between;gap:16px;align-items:flex-start;flex-wrap:wrap}.mc-editor-description{max-width:760px}.mc-module-group{border:1px solid #F3F4F6;border-radius:18px;padding:20px;margin-top:16px;background:linear-gradient(180deg,#FFFFFF,#FFFFFF)}.mc-module-group h3{margin:0;color:#071525;font-size:17px}.mc-module-group-desc{font-size:12px;color:#6B7280;margin:5px 0 0}.mc-module-group .form-grid{margin-top:16px}.mc-specific-field{padding:2px 0}.mc-original-note{font-size:11px;color:#6B7280;margin-top:5px}.mc-image-field input[type=file]{width:100%}.mc-current-image{display:grid;grid-template-columns:minmax(150px,230px) 1fr;gap:14px;align-items:center;margin-top:10px}.mc-current-image img{display:block;width:100%;height:130px;object-fit:cover;border-radius:12px;border:1px solid #F3F4F6;background:#FFFFFF}.mc-clear-check{font-size:12px!important;font-weight:700!important;color:#374151!important}.mc-color-row{display:flex;align-items:center;gap:10px;flex-wrap:wrap}.mc-color-row input[type=color]{width:54px;height:42px;padding:2px;border:1px solid #F3F4F6;border-radius:9px;background:#FFFFFF}.mc-color-row code{background:#FFFFFF;padding:7px 9px;border-radius:8px}.mc-color-use{font-size:12px!important;margin-left:auto}.mc-module-switch{display:flex;align-items:center;gap:10px;padding:14px 16px;border:1px solid #F3F4F6;background:#F3F4F6;border-radius:14px;font-weight:800;color:#071525}.mc-module-switch input{width:18px;height:18px}.mc-advanced{margin-top:18px;border:1px dashed #F3F4F6;border-radius:16px;padding:14px}.mc-advanced summary{cursor:pointer;font-weight:800;color:#374151}.mc-dedicated{padding:34px;text-align:center;border:1px solid #F3F4F6;background:#F3F4F6;border-radius:18px;margin-top:18px}.mc-dedicated h3{font-size:22px;color:#071525;margin:0}.mc-dedicated p{max-width:650px;margin:10px auto 18px;color:#374151}.mc-sticky-actions{position:sticky;bottom:10px;z-index:10;margin-top:20px;padding:12px;background:rgba(255,255,255,.94);border:1px solid #F3F4F6;border-radius:14px;box-shadow:0 10px 30px rgba(7,21,37,.10);backdrop-filter:blur(10px)}
