...
?>
<style>
.news-admin-head{display:flex;justify-content:space-between;align-items:center;gap:14px;flex-wrap:wrap}.news-admin-head p{margin:5px 0 0;color:#718096}.news-editor-grid{display:grid;grid-template-columns:minmax(0,1.3fr) minmax(300px,.7fr);gap:18px}.news-media-box{border:1px solid #dbe5ef;border-radius:14px;padding:14px;background:#f8fbff}.news-media-box h3{margin:0 0 4px}.media-sortable{display:grid;grid-template-columns:repeat(auto-fill,minmax(190px,1fr));gap:12px;margin-top:12px}.media-item{position:relative;border:1px solid #dbe5ef;border-radius:13px;background:#fff;padding:10px;cursor:grab;box-shadow:0 7px 18px rgba(7,26,51,.05)}.media-item.dragging{opacity:.45}.media-item img{display:block;width:100%;aspect-ratio:16/10;object-fit:cover;border-radius:9px;background:#e8eef5}.media-item input[type=text]{width:100%;margin-top:8px}.media-item .media-row{display:flex;align-items:center;justify-content:space-between;gap:8px;margin-top:8px;font-size:12px}.media-handle{font-weight:900;color:#315d88}.new-slot-preview{display:grid;place-items:center;width:100%;aspect-ratio:16/10;border-radius:9px;background:#edf3f9;color:#7a8ba0;overflow:hidden}.new-slot-preview img{width:100%;height:100%;object-fit:cover}.news-note{padding:11px 13px;border-radius:11px;background:#eaf2fa;color:#294d73;font-size:12px;line-height:1.55}.status-actions{display:flex;gap:6px;flex-wrap:wrap}.news-title-cell{max-width:420px}.news-title-cell b{display:block}.photo-badge{display:inline-flex;align-items:center;gap:5px;margin-top:5px;padding:4px 7px;border-radius:999px;background:#edf3f9;color:#315d88;font-size:11px;font-weight:800}@media(max-width:980px){.news-editor-grid{grid-template-columns:1fr}}@media(max-width:640px){.media-sortable{grid-template-columns:1fr}}
</style>
