...
function mc_opinion_admin_badge($status){
    $map=[
        'pendiente'=>['Pendiente','#F3F4F6','#0B1F3A'],
        'publicado'=>['Publicado','#F3F4F6','#071525'],
        'rechazado'=>['Rechazado','#F3F4F6','#0B1F3A'],
        'oculto'=>['Oculto','#F3F4F6','#374151'],
    ];
    return $map[$status]??[$status,'#FFFFFF','#374151'];
}

mc_admin_header('Opiniones y calificaciones');
?>
<style>
.op-stats{grid-template-columns:repeat(5,minmax(0,1fr))}.op-stars{color:#163A5F;letter-spacing:2px}.op-table{width:100%;border-collapse:collapse}.op-table th,.op-table td{padding:12px 10px;border-bottom:1px solid #F3F4F6;text-align:left;vertical-align:top}.op-table th{font-size:12px;text-transform:uppercase;letter-spacing:.05em;color:#374151}.op-comment{max-width:430px;line-height:1.55}.op-actions{display:flex;flex-wrap:wrap;gap:6px}.op-mini{border:0;border-radius:8px;padding:7px 9px;font-weight:700;cursor:pointer;font-size:12px}.op-green{background:#F3F4F6;color:#071525}.op-orange{background:#F3F4F6;color:#0B1F3A}.op-red{background:#F3F4F6;color:#0B1F3A}.op-gray{background:#FFFFFF;color:#374151}.op-blue{background:#F3F4F6;color:#0B1F3A}.op-filter{display:flex;flex-wrap:wrap;gap:8px;margin:15px 0}.op-filter a{padding:8px 12px;border:1px solid #F3F4F6;border-radius:999px;text-decoration:none;color:#374151;font-weight:700;font-size:13px}.op-filter a.active{background:#071525;color:white;border-color:#071525}.op-consent{font-size:11px;color:#6B7280}.op-edit{margin-bottom:18px}@media(max-width:1000px){.op-stats{grid-template-columns:repeat(2,minmax(0,1fr))}.op-table{min-width:900px}.op-table-wrap{overflow:auto}}
</style>
