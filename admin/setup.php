...
if ($_SERVER['REQUEST_METHOD']==='POST') {
    ...
    elseif (strlen($recoveryPhone)<10) $error='Ingresa un WhatsApp de recuperación válido con código de país. Ejemplo: 519xxxxxxxx.';
    else {
        $hash=password_hash($p,PASSWORD_BCRYPT);
        if (mc_write_admin_credentials($u,$hash,$recoveryPhone)) {
