...
<head>
    ...
    <script>tailwind.config={theme:{extend:{colors:{'brand-green':'#1F4E79','brand-green-dark':'#0B1F3A','brand-orange':'#64748B'}}}};</script>
    ...
    <style>
        .mc-credit-summary{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));margin-top:2rem;background:#FFFFFF!important;color:#061426!important;border:1px solid rgba(11,31,58,.14);border-radius:24px;box-shadow:0 18px 55px rgba(0,0,0,.14);overflow:hidden}
        ...
        .mc-credit-summary-label{display:block;color:#64748B!important;font-size:.78rem;font-weight:800;text-transform:uppercase;letter-spacing:.08em}
        ...
        .mc-benefit-panel{background:#FFFFFF!important;color:#061426!important;border:1px solid rgba(11,31,58,.14);border-radius:24px;padding:2rem;box-shadow:0 16px 45px rgba(5,11,20,.10)}
        .mc-benefit-panel i{color:var(--mc-accent)!important;font-size:1.7rem}
        .mc-benefit-panel h3{color:#061426!important;font-size:1.25rem;font-weight:900;margin-top:1rem}
        .mc-benefit-panel p{color:#64748B!important;font-size:.95rem;line-height:1.7!important;margin-top:.55rem}
...
<section class="relative overflow-hidden bg-gradient-to-br from-[#0B1F3A] via-[#1F4E79] to-[#1F4E79] text-white">
 ...
 <div class="max-w-7xl mx-auto px-4 md:px-10 py-16 md:py-24 relative z-10">
  ...
  <h1 class="text-4xl md:text-6xl font-black mt-5 tracking-tight">Bancos Comunales</h1>
  <p class="text-lg md:text-xl text-green-50 mt-4 max-w-3xl leading-relaxed">Organización, confianza y acompañamiento para impulsar pequeños negocios y fortalecer las oportunidades de sus integrantes.</p>
 </div>
</section>
